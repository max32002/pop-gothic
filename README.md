...
目前緩慢地補字中...，每天增加幾個字，第一階段是要完成4800個台灣常用字，初步是缺659字。
...
[https://youtu.be/eMLZxgJWzrk](https://youtu.be/eMLZxgJWzrk)


以描摹方式建立或更新字型

[https://youtu.be/xSAN43F3wwI](https://youtu.be/xSAN43F3wwI)
...
* 本字型是基於 SIL Open Font License 1.1 改造GoogleFonts所發表的「[はちまるポップ](https://github.com/noriokanisawa/HachiMaruPop)」字型。
